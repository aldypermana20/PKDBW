    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center justify-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Mulai atur keuangan Anda hari ini</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Daftar</CardTitle>
            <CardDescription>Isi data diri Anda untuk membuat akun baru</CardDescription>
          </CardHeader>
          <CardContent>
            {success ? (
